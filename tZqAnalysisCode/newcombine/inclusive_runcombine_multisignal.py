...
##############################################################
# extension: use multiple signals (e.g. tZq and ttZ simultaneously)
# note: added at a relatively late stage of the analysis (referee comments),
#       based on topchannels_runcombine.py
...
def get_po_map_new( cards, processes=['tZq'] ):
    ### define the mapping of signal strengths
    # input arguments:
    # - cards: list of datacards
    # - processes: list of signal processes
    parameters = []
...
if __name__=="__main__":
	...
	card = cards[0]
        print('running combine for '+card)
	commands = []
        (pois,pomap) = get_po_map_new( cdict.values(), ['tZq','ttZ'] )
