...
class LeptonCollection : public PhysicsObjectCollection< Lepton > {
    ...
    public:
        ...
        void selectLooseLeptons_chargemap();
        void selectTightLeptons_chargemap();
        ...
        double bestZBosonCandidateMass(bool sameSign = false) const;
        std::pair< size_type, size_type > bestZBosonCandidateIndices(bool sameSign = false) const;
        std::pair< std::pair< size_type, size_type >, double > bestZBosonCandidateIndicesAndMass(bool sameSign = false) const;
